...
export default function PackageSearchBar({setAllResults,setLastSearchTerm,isLoading,setIsLoading,setCurrentPage}:any){
  //search input states
  ...
  return(
    <section className='package-search'>
      ...
      <form className='search-field'>
        ...
        <button type='button' style={{color: getButtonTextColor(isLoading)}} className='search-button' onClick={()=>{handleSearch(archInput,repoInput,searchInput,setAllResults,setLastSearchTerm,setIsLoading,setCurrentPage)}}>Search</button>
        <button type='button' style={{color: getButtonTextColor(isLoading)}} className='lucky-button' onClick={()=>{handleLuckySearch(setAllResults,setLastSearchTerm,setIsLoading,setCurrentPage)}}>I'm Feeling Lucky</button>
        <img className='loading' style={{display: getLoadingImgStyle(isLoading)}} src={loadingImg} alt='spinning circle indicating loading' />
      </form>
    </section>
  )
}
//if the search is loading show the spinning loading image
const getLoadingImgStyle = function(isLoading:boolean){
  if (isLoading){
    return 'block';
  }else{
    return 'none';
...
const getButtonTextColor = function(isLoading:string):string{
...
const getServerUrl = function(searchInput:any){
  if (USE_LOCALHOST){
...
export const handleSearch = async function(archInput:any,repoInput:any,searchInput:any,setAllResults:any,setLastSearchTerm:any,setIsLoading:any,setCurrentPage:any){
  let searchResults = [];
  // lock buttons
